...
public class personas extends persona {
    ...
    String[]atributos1= {"pulseras","pulseras","pulseras","collar","collar","collar","anillos","anillos","audifonos","audifonos"};
	String[]atributos2= {"lentes","lentes","lentes","aretes","aretes", "aretes","gorra","gorra","sudadera","sudadera"};
	...
	public String pop(String[]stacks,int top) {
		...
		public void getInfo() {
            ...
            System.out.println("5.Lentes");
            System.out.println("6.Aretes");
            System.out.println("7.Gorra");
            System.out.println("8.Sudadera");
